  ...
  return (
    <SafeAreaView style={styles.safe}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerSub}>RF06 - Escaneo de asistencia</Text>
      </View>
      ...
      <ScrollView contentContainerStyle={{ paddingBottom: 30 }}>
        ...
        <View style={{ padding: 16 }}>
          {/* Botón simular cámara */}
          <TouchableOpacity style={styles.simBtn} onPress={simularEscaneo} disabled={scanning}>
            <Text style={styles.simBtnText}>{scanning ? '⏳ Procesando...' : '🎯 SIMULAR ESCANEO'}</Text>
          </TouchableOpacity>
          ...
          <View style={styles.manualRow}>
            ...
            />
            <TouchableOpacity style={styles.validateBtn} onPress={() => { if (qrInput) procesarAcceso(qrInput); else Alert.alert('', 'Ingresa un ID'); }}>
